{
    ...
    \begin{longtable}{| g{.8\TabColumnWidth} | g{\TabColumnWidth} | g{\TabColumnWidth}| g{\TabColumnWidth}| g{\TabColumnWidth}| g{\TabColumnWidth}|}
        ...
        \hline \rowcolor{Gray}
        \headcell{Criteria} & \headcell{Traeger} & \headcell{softing} & \headcell{Unified~Automation} & \headcell{OPC~Foundation\\ UA-.NET Standard} \\\hline
        \endfirsthead
        ...
        % Traeger
        \itemcell{
            \itemU \href{https://opcua.traeger.de/en/}{Traeger~Home}
        } &
        % softing
        \itemcell{
            \itemU \href{https://industrial.softing.com/products/opc-ua-and-opc-classic-sdks/opc-ua-net-standard-sdk.html}{softing~Product}
        } &
        % UA
        \itemcell{
